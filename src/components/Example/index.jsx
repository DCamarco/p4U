...
class Example extends React.Component {
	...
	handleUserMottoChange(event) {
		this.setState({ userMotto: event.target.value });
	}
		...
		return (
			<div className='container Example'>
				...
				<div className='motto-update'>
					...
					<p>Motto of the day: {this.state.inputValue}</p>

					<label htmlFor='inId'>Input Field:</label>
					<input
						id='inId'
						type='text'
						placeholder={this.state.userMotto}
